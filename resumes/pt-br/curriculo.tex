...
\section{Certificações}
    \begin{itemize}
        ...
        \item \textbf{EF SET English Certificate} · C2 Proficiente
        (\href{https://cert.efset.org/en/FXfQvC}{cert.efset.org/en/FXfQvC})
    \end{itemize}
...
\section{Habilidades}
    \begin{itemize}
        ...
        \item \textbf{Idiomas:} Português (Nativo), Inglês (C2 — Proficiente)
    \end{itemize}
